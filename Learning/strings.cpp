...
int main(void)
{
	...
	.find(string,indentToLookFrom) - to get a specific string in your variable . This function can be used by passing the string you want to find followed by the indent to start looking from 
	 ...
	 */
	 ...
	 cout <<"This is the substring we removed : "<<sub<<endl;
